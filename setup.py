...
database.add_schedule_item(
    station_id="RSH", starttime=datetime.datetime.now(), runtime=1, filepath=None
)
database.add_schedule_item(
    station_id="LOS40",
...
print(
    database.get_scheduled_events(
        future_events=True, completed_events=False, active_events=False
    )
)
